...
In this video, the simulated needle tip positions are still used (no FBG needles were available to be used on the robot). 
The robot inserts in a straight line towards the target using MPC.
